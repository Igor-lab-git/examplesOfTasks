...
async function getProducts() {
    try {
        if(!productsData.length) { // что бы лишний раз не делать запрос на сервер, проверяем существующий массив и его длинну продуктов если он не пустой не функю не вызывается
