...
const renderCard = (product) => {
    ...
    const { id, model, photo, prices } = product;
    
    const liElement = document.createElement("li");
    liElement.classList.add("product", "item", "column", "aic", "js-product");
...
const appendProductCard = (product, productContainer) => {
...
const renderProductCards = (products, productContainer) => {
    ...
    products.forEach(product => {
        ...
        appendProductCard(card, productContainer);
    });
